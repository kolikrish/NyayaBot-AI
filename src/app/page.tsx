        ...
        <div className="container mx-auto max-w-5xl relative z-10">
          <div className="text-center mb-14">
            ...
            <p className="text-base md:text-lg text-gray-300 max-w-2xl mx-auto mb-10 leading-relaxed">
              NyayaBot is your AI-powered legal assistant, making Indian law accessible and understandable for everyone.
            </p>
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">
              How NyayaBot Can <span className="text-orange-500">Help You</span>
            </h2>
            <div className="h-[2px] w-16 bg-orange-500/60 mx-auto mb-6"></div>
      ...
      <section className="py-20 bg-black">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <div className="h-[2px] w-16 bg-orange-500/60 mx-auto mb-6"></div>
            <p className="text-sm md:text-base text-gray-400 max-w-2xl mx-auto mb-10">
              NyayaBot provides information on a wide range of legal topics relevant to Indian citizens.
            </p>
          </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="md:w-2/3">
                ...
                <p className="text-sm md:text-base text-gray-300 mb-0 md:mb-4 max-w-xl">
                  Start a conversation with NyayaBot now and get the legal information you need.
                </p>
              </div>
